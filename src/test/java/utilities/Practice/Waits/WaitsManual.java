...
public class WaitsManual {
    ...
    public static void explicitVisibility(){
        ...
        driver.findElement(By.xpath("//button[.='Start']"));

        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5));
        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//h4[.='Hello World!']")));
    ...
    public static void explicitAddedToDOM(){
        ...
        driver.findElement(By.xpath("//h4[.='Hello World!']"));
